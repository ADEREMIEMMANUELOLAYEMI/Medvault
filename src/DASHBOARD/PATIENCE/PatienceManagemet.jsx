...
import Tabs from "../PATIENCE/Tabs";
import SearchBar from "../PATIENCE/SearchBar";
import DoctorTable from "../PATIENCE/DoctorTable";
import Pagination from "../PATIENCE/Pagination";

export default function App() {
  return (
    <div className="min-h-screen bg-[#f7f6fb] p-4 md:p-6 w-full">
      {/* Tabs */}
      <Tabs />
...
//                   }
//                 >
//                   <Icon icon={'tabler:stack-filled'} className='mr-2 text-[#808080] w-[24px] h-[21.6px]'  /> 
//                   <span className="text-[#84828A] w-[201px] h-[20px] text-[16px] leading-[100%] font-normal font-readex ">Department Management</span>
//                 </NavLink>
//               </li>
...
//                   <span className="text-[#84828A] w-[201px] h-[20px] text-[16px] leading-[100%] font-normal font-readex"> Payment Status</span> 
//                 </NavLink>
//               </li>
...
//                   }
//                 >
//                   <Icon icon='streamline-plump:customer-support-7-solid' className='mr-2 text-[#808080] w-[24px] h-[21.6px]' /> <span className="text-[#84828A] w-[201px] h-[20px] text-[16px] leading-[100%] font-normal font-[Readepro]">Support and Compliance</span>
//                 </NavLink>
//               </li>
